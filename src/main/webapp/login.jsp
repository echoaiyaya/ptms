				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">南京大学紫金学院－学生管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
